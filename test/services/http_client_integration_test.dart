...
void main() {
  group('HttpClient Integration Tests', () {
    ...
    test('should make successful GET request to real API', () async {
    ...
    test('should make successful POST request to real API', () async {
      final postData = {
        'title': 'Test Post',
    ...
    test('should handle 404 errors correctly', () async {
      ...
      try {
        await httpClient.get<Map<String, dynamic>>('/posts/invalid-endpoint-that-does-not-exist');
    ...
    test('should handle query parameters in real requests', () async {
      final result = await httpClient.get<List<dynamic>>(
        '/posts',
